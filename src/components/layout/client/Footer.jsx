  ...
  return (
    <footer className="bg-white dark:bg-slate-900 border-t border-[#e7ebf3] dark:border-slate-800 py-12 px-6">
      <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
        <div className="col-span-1 md:col-span-1">
          ...
          <p className="text-slate-500 text-sm leading-relaxed">
            Hệ thống tra cứu văn bản pháp luật hàng đầu Việt Nam. Cung cấp
        ...
        <div>
          ...
          <div className="flex gap-4">
            <a
              className="size-10 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-slate-600 dark:text-slate-400 hover:bg-primary hover:text-white transition-all"
              href="#"
            >
      ...
      <div className="max-w-[1200px] mx-auto mt-16 pt-8 border-t border-slate-100 dark:border-slate-800 text-center text-xs text-slate-400">
        © 2024 Vietnam Law Portal. Tất cả các quyền được bảo lưu.
      </div>
    </footer>
  );
}
