    ...
    return (
        <aside className="w-72 flex flex-col border-r border-slate-200 dark:border-slate-800 bg-white dark:bg-[#161b22] h-full">
            <Link
                ...
                <h2 className="text-lg font-bold tracking-tight text-blue-700">AI Luật Sư</h2>
            </Link>
            ...
            <nav className="flex-1 overflow-y-auto custom-scrollbar px-3">
                <h3 className="text-sm font-bold text-slate-700 dark:text-slate-200 px-3 py-3">Lịch sử trò chuyện</h3>
