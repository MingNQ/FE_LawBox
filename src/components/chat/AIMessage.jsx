import { Bot, FileText, FileCheck, Copy, Share2, ThumbsUp, ThumbsDown } from "lucide-react";
    ...
    return (
        <div className="flex items-center gap-3 p-3 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 hover:border-primary transition-all cursor-pointer group">
            ...
            <div className="overflow-hidden">
                <p className="text-xs font-bold truncate group-hover:text-blue-700 transition-colors">{title}</p>
                <p className="text-[10px] text-slate-500 uppercase tracking-tight">{code}</p>
            </div>
        </div>
    );
}
