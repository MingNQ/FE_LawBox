      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar p-6 space-y-8">
        ...
        <AIMessage time="14:21 PM">
          <p>
            ...
            <strong>Luật Kinh doanh Bất động sản</strong>), bạn cần đặc biệt lưu
            ý các điểm sau về đơn phương chấm dứt hợp đồng:
          </p>
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li>
              ...
              mà gây thiệt hại thì phải bồi thường. Trong hợp đồng 5 năm, thông
              thường các bên thỏa thuận báo trước từ{" "}
              <strong>30 đến 90 ngày</strong>.
            </li>
            <li>
              <strong>Hoàn trả tiền cọc:</strong> Cần làm rõ trường hợp nào được
              lấy lại cọc nếu chủ nhà lấy lại mặt bằng trước hạn mà không có lỗi
              của bên thuê.
            </li>
          </ul>
