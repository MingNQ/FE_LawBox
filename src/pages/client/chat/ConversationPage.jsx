...
import { getMyConversation } from "../../../api/conversationApi";
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar p-6 space-y-8">
          ...
          <AIMessage time="14:21 PM">
            ...
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li>
                <strong>Thời hạn báo trước:</strong> Theo quy định, bên đơn
                phương chấm dứt phải thông báo ngay cho bên kia biết. Nếu không
                thông báo mà gây thiệt hại thì phải bồi thường. Trong hợp đồng 5
                năm, thông thường các bên thỏa thuận báo trước từ{" "}
