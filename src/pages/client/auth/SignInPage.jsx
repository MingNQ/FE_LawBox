              ...
              <div className="space-y-5">
                ...
                <div className="flex items-center justify-between py-1">
                  <label className="flex items-center gap-2 cursor-pointer group">
                    <input
                      className="w-4 h-4 rounded border-[#cfd7e7] text-blue-700 focus:ring-primary/20 transition-all cursor-pointer"
                      type="checkbox"
                    />
                ...
                <button
                  className="w-full bg-blue-700 hover:bg-blue-700/90 text-white font-bold py-3.5 rounded-lg shadow-lg shadow-primary/20 transition-all active:scale-[0.98]"
                  type="submit"
                >
                  Đăng nhập
                </button>
